...
def _convert_scalar_seq_type_input_to_tuple(
    type_input: Optional[Union[type, Sequence[type]]],
    ...
    input_name : str, default=None
        Name of the input type(s). Used to raise informative error message. If none,
        then "type_input" is used as name in error message.
    ...
    # allowed subclasses of types, then convert to tuple of types
        ...
        raise TypeError(f"`{name_str}` should be a type or sequence of types.")
